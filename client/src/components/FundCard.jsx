    ...
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
        ...
        <div className="flex flex-col p-4">
            ...
            <div className="block">
                ...
                <p className='font-epilogue font-normal mt-[5px] text-[#808191] text-left leading-[18px] truncate'>{description}</p>
            </div>
            ...
            <div className='flex items-center mt-[20px] gap-[12px]'>
                <div className='w-[30px] h-[30px] rounded-full justify-center items-center bg-[#13131a]'>
                    <img src="https://img.icons8.com/ios-filled/50/gender-neutral-user.png" alt="user" className=' w-[90%] h-[90%] object-contain'/>
                </div>
