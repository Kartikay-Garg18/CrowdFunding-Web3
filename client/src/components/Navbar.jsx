  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      ...
      <div className='sm:flex hidden flex-row justify-end gap-4'>
        ...
        <Link to='/profile'>
          <div className='w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer'>
            <img src="https://img.icons8.com/ios-filled/50/gender-neutral-user.png" alt="user" className='w-[60%] h-[60%] object-contain'/>
          </div>
        </Link>
      </div>
      ...
      <div className='sm:hidden flex justify-between items-center relative'>
          ...
          <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${!toggleDrawer? '-translate-y-[100vh]' : 'translate-y-0'} translate-all duration-700`}>
            <ul className='mb-4 '>
              {navlinks.map((link) => (
                <li
                key={link.name}
